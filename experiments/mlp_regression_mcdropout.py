...
# DATASET : https://archive.ics.uci.edu/ml/datasets/Physicochemical+Properties+of+Protein+Tertiary+Structure#
...
for step in range(1000):
    ...
    train_loss = wrapper.train_on_dataset(al_dataset, optimizer=optimizer, batch_size=16,
                                          epoch=1000, use_cuda=use_cuda, workers=0)
